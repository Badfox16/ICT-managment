    ...
    <div class="d-flex flex-column p-3 text-white bg-dark position-fixed" style="width: 300px; height:100vh;">
            ...
            <ul class="nav nav-pills flex-column mb-auto">
                <li class="nav-item flex ">
                    <a href="dashboard.php" class="nav-link my-4 active ">
                        Menu Principal
                    </a>
                </li>
                <li>
                ...
                <li>
                    <a href="../Softwares/softwares.php" class="nav-link text-white mb-4">
                        Software
                    </a>
                </li>
                <li>
            ...
            <div class="d-flex flex-column">
                ...
                <a href="../ICT/Controllers/Logout.php" class="d-flex align-items-center text-white text-decoration-none m-2" aria-expanded="false">
                    <span>
      ...
      <div class="card-body" style="width: calc(100% - 300px); margin-left: 300px; overflow-y: scroll;">
        ...
        <section class="middle-content container-fluid bg-muted pt-4">
          ...
          <div class="cards d-flex mb-5">
            ...
            <div class="card-equipment">
              <div class="card-equimpment-img">
                <img src="./img/hardware.png" alt="Imagem do Equipamento">
              </div>
              <h5>Equipamento</h5>
