...
<section class="d-flex">
    <div class="d-flex flex-column p-3 text-white bg-dark position-fixed" style="width: 300px; height:100vh;">
        ...
        <div class="d-flex flex-column">
            <a href="./Perfil.php" class="d-flex align-items-center text-white text-decoration-none m-2"
               aria-expanded="false">
                    <span>
            ...
            <a href="./Controllers/Logout.php" class="d-flex align-items-center text-white text-decoration-none m-2"
               aria-expanded="false">
                    <span>
    ...
    <div class="card-body" style="width: calc(100% - 300px); margin-left: 300px; overflow-y: scroll;">
                ...
                <form method="post" action="./Controllers/Cadastrar.php">
                    <div class="d-flex">
                        <div class="">
                            ...
                            <input type="text" id="nrSerie" class="form-control largura" name="email"
                                   placeholder="Insira o numero de série" required>
                        </div>
                        <div class="mb-3">
                            <label for="username" class="form-label">Titulo:</label>
                            <input type="text" class="form-control largura" name="username"
                                   placeholder="Insira o titulo da manutenção" required>
                        </div>
                    </div>
                    <div class="mb-3">
        ...
        <div class="">
                ...
                <?php foreach ($Manutencoes as $manutencao) : ?>
                    <tr style="height: 16px;">
                        ...
                        <a href="#" data-toggle="modal"
                           data-target="#userInfoModal<?= $manutencao['Id_Manutencao']; ?>">
                                    <span style="font-size: 1.5rem; color:#343A40; padding-left: 16px;"
                                          aria-hidden="true">
            ...
            <!-- Modal -->
            <?php foreach ($Manutencoes as $manutencao) : ?>
                <div class="modal fade" id="userInfoModal<?= $manutencao['Id_Manutencao']; ?>" tabindex="-1"
                     role="dialog" aria-labelledby="userInfoModalLabel" aria-hidden="true">
