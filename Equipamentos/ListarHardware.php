  ...
  <main class="main container-fluid d-flex">
    ...
    <section class="right-content container-fluid bg-muted pt-4">
      ...
      <div class="main-content">
        ...
        <div class="modal fade" id="adicionarTipoModal" tabindex="-1" aria-labelledby="adicionarTipoModalLabel" aria-hidden="true">
          <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
              <div class="modal-header">
          ...
          <table class="table table-hover ">
            ...
            <tbody>
              ...
              <?php foreach ($equipamentos as $equipamento) : ?>
                ...
                <div class="modal fade" id="editarEquipamentoModal" tabindex="-1" aria-labelledby="editarEquipamentoModalLabel" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
