...
$arquivo = 'Relatorio_Computador.pdf';
...
$tabela .= '<td><b>RAM Instalada</b></td>';
$tabela .= '<td><b>ROM</b></td>';
...
$tabela .= '<td>'.$dados['DescricaoComputador'].'</td>';
...
$tabela .= '<td>'.$dados['RAM'].'</td>';
$tabela .= '<td>'.$dados['ROM'].'</td>';
